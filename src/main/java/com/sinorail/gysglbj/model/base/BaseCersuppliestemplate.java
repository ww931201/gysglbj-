...
public abstract class BaseCersuppliestemplate<M extends BaseCersuppliestemplate<M>> extends Model<M> implements IBean {
	...
	public void setZslb2(java.lang.String zslb2) {
		set("ZSLB2", zslb2);
	}

	public java.lang.String getZslb2() {
		return get("ZSLB2");
	}
